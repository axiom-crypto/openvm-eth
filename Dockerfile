...
RUN rustup toolchain install nightly-2026-09-10

# Install cargo-openvm (builds the guest ELF)
RUN cargo +1.91.1 install --git https://github.com/openvm-org/openvm.git --rev 594b044e705891bcc2abd01578410da7dfcd1efe --locked --force cargo-openvm
...
RUN cargo +nightly-2026-09-10 build --bin openvm-reth-benchmark --profile=${PROFILE} --no-default-features --features=${FEATURES}
