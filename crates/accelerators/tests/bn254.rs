...
use openvm_accelerators::{
    ...
    zkvm_bn254_pairing, zkvm_bn254_pairing_pair, zkvm_bn254_scalar, ZKVM_EFAIL, ZKVM_EOK,
};

fn scalar(value: u8) -> zkvm_bn254_scalar {
    let mut scalar = zkvm_bn254_scalar { data: [0; 32] };
    scalar.data[31] = value;
    scalar
}

/// BN254 generator (1, 2).
fn generator() -> zkvm_bn254_g1_point {
    let mut point = zkvm_bn254_g1_point { data: [0; 64] };
    point.data[31] = 1;
    point.data[63] = 2;
    point
}
...
const BN254_2GEN: zkvm_bn254_g1_point = zkvm_bn254_g1_point {
    data: hex!(
...
const BN254_NEG_GEN: zkvm_bn254_g1_point = zkvm_bn254_g1_point {
    data: hex!(
...
const BN254_G2_GEN: zkvm_bn254_g2_point = zkvm_bn254_g2_point {
    data: hex!(
...
fn zkvm_bn254_pairing_smoke() {
    let pairs = [
        zkvm_bn254_pairing_pair { g1: generator(), g2: BN254_G2_GEN },
        zkvm_bn254_pairing_pair { g1: BN254_NEG_GEN, g2: BN254_G2_GEN },
    ];
...
fn bn254_rejects_invalid_point() {
    ...
    let pairs = [zkvm_bn254_pairing_pair { g1: not_on_curve, g2: BN254_G2_GEN }];
...
fn zkvm_bn254_null_pointers() {
    ...
    let pairs = [zkvm_bn254_pairing_pair { g1: point, g2: BN254_G2_GEN }];
    let mut verified = false;
